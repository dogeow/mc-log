...
<div class="container mx-auto p-4 space-y-8">
    <h1 class="text-2xl font-bold mb-4">Minecraft 服务器统计</h1>
            ...
            <table class="min-w-full">
                <thead>
                    <tr>
                        ...
                        <th class="px-4 py-2">
                            <a href="{{ request()->fullUrlWithQuery(['sort' => 'is_online', 'direction' => request('direction') === 'asc' && request('sort') === 'is_online' ? 'desc' : 'asc']) }}" class="flex items-center">
                                是否在线
                                @if(request('sort') === 'is_online')
                                    <span class="ml-1">{{ request('direction') === 'asc' ? '↑' : '↓' }}</span>
                                @endif
                            </a>
                        </th>
